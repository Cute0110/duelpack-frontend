...
const RandingPage = ({ packsData, forgeData }: any) => {
  ...
  const commentsLeftData = [
    ...
    { title: 'Is DuelPack safe and fair to use?', content: 'bsolutely! PackDraw was launched in 2022 to set a new standard of integrity, utilizing EOS Blockchain technology to guarentee security. We are dedicated to delivering a fair and enjoyable experience for all users, with a focus on transparency and integrity. For more details on our commitment to fairness and how our algorithm operates, visit our dedicated page at https://packdraw.com/fairness.', key: 2 },
    { title: 'Is DuelPack trustworthy?', content: 'Certainly. Trust and security are fundamental to PackDraw. Our vibrant community and responsive customer service demonstrate our commitment to providing a safe and dependable platform. You can rely on PackDraw for a trustworthy and secure experience every time.', key: 3 },
    { title: 'How do I open a pack?', content: 'Explore our range of packs under the "Packs" tab at the top of the page. Each pack features a unique design and theme, displaying the products and their winning probabilities. Once you have found your desired pack and have sufficient balance, click "Open" to watch the animation and discover the product you have won. Landing on a gold PackDraw icon means you have hit the jackpot!', key: 4 },
  ]
  const commentsRightData = [
    ...
    { title: 'How do I get Support?', content: 'If you need further assistance, do not hesitate to reach out to our support team. You can contact us anytime at support@packdraw.com. We are here to help resolve any queries or concerns you may have.', key: 8 },
  ]
