...
import DepositsTable from "./WithdrawalsTable";
import WithdrawalsTable from "./WithdrawalsTable";
import ProfileMobileMenu from "../ProfileMobileMenu";

const ProfileWithdrawalsScreen = ({ originalData, onGetTableDataAction, isLoading }: any) => {
                ...
                <div className="flex gap-8">
                    ...
                    <div className="w-full">
                        <div className="flex items-center justify-between relative">
                            <div className="hidden md:block text-white text-3xl font-bold">Withdrawals</div>

                            <div className="block md:hidden bg-[#22272b] rounded-md px-8 py-2 cursor-pointer" onClick={() => setIsMenuOpen(true)}>Withdrawals</div>
...
export default ProfileWithdrawalsScreen;
