...
const WithdrawalsTable = ({data, setOrderData} : any) => {
  ...
  const columns: TableColumnsType<DataType> = [
    ...
    {
      title: <HeadTitle title={"Amount"} sortDir={receivedAmountDir} onSortClick={onSortClick}/>,
    ...
    {
      title: <HeadTitle title={"Prev Balance"} sortDir={userPrevBalanceDir} onSortClick={onSortClick}/>,
    ...
    {
      title: <HeadTitle title={"After Balance"} sortDir={userAfterBalanceDir} onSortClick={onSortClick}/>,
    ...
    {
      title: <HeadTitle title={"Date"} sortDir={createdAtDir} onSortClick={onSortClick}/>,
