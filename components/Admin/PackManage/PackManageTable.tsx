...
const PackManageTable = ({data, onUserStatusChangeAction, onDeleteUser, onResetPassword, onClickUserTransaction, setOrderData} : any) => {
  ...
  const columns: TableColumnsType<DataType> = [
    ...
    },
    {
      ...
      render: (imageUrl) => (
        <img src={`/images/packs/${imageUrl}`} className='w-12 h-auto' />
      )
    },
    {
...
export default PackManageTable;